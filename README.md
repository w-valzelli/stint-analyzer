...
The app detects the Garage 61 session sheet, discovers sectors, preserves source fields, identifies duplicate file bytes, and checks track consistency across imports. Scope review hides incomplete laps from analysis while keeping them available in the lap audit. The leaderboard ranks selected runtime and shows runtime gaps, clean-lap fractions, clean percentage, best clean lap, and median clean lap. Sector screens, consistency views, driver details, and exports arrive in later milestones.
